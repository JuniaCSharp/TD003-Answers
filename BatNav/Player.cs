...
namespace BatNav
{
    ...
    public class Player : Gamer
	{
        ...
        public Player(string pseudo, Guid id, int strikeCredit, AppDef.PlayerStatus status) : base (pseudo, id)
        {
		...
		private int _nbStruck = 0;
		public int NbStruck { get=>_nbStruck; set => _nbStruck=value; }
